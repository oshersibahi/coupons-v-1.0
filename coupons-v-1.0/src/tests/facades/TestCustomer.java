...
public class TestCustomer {
	...
	public static void main(String[] args) {
		...
		Coupon coupon3 = new Coupon(0, 0, Category.FOOD, "free food", "buy in 100$ get 3 pizzas",
				LocalDate.now(), LocalDate.now().plusDays(1), 10, 100, null);
...
//				cf.addCoupon(coupon5);
			...
			if(cfc.login(customer1.getEmail(), customer1.getPassword())) {
				System.out.println("================================================");
				cfc.purchaseCoupon(coupon1);
				cfc.purchaseCoupon(coupon2);
				cfc.purchaseCoupon(coupon3);
				cfc.purchaseCoupon(coupon4);
				cfc.purchaseCoupon(coupon5);
//				System.out.println("================================================");
//				cfc.purchaseCoupon(coupon1);
				System.out.println("================================================");
				System.out.println(cfc.getCustomerCoupons());
				System.out.println("================================================");
				System.out.println(cfc.getCustomerCoupons(Category.FOOD));
				System.out.println("================================================");
				System.out.println(cfc.getCustomerCoupons(85));
				System.out.println("================================================");
				System.out.println(cfc.getCustomerDetails());
